...
# 🔧 ACTIVE SCENARIOS (uncomment to run more)
ESCENARIOS = [
    # ========================================================================
    # DEBUG SCENARIOS - High density, strong disturbance for clear jam formation
    # ========================================================================
    {
        "nombre": "DEBUG_Dense_N45_V25_D18",
        "num_cars": 45,              # High density
        "car_max_speed": 25.0,
        "car_acc_max": 2.5,
        "car_dec_max": 4.5,
        "s0": 3.0,                   # Slightly larger minimum gap
        "t_reaction": 1.2,           # Slower reactions
        "disturbance_start": 10.0,
        "disturbance_duration": 7.0, # Longer disturbance
        "disturbance_decel": -18.0,  # Very hard brake
        "enable_visual": False
    },
    {
        "nombre": "DEBUG_VeryDense_N50_V25_D15",
        "num_cars": 50,              # Very high density
        "car_max_speed": 25.0,
        "car_acc_max": 2.5,
        "car_dec_max": 4.5,
        "s0": 3.5,
    ...
    # ========================================================================
    # BASELINE DENSITY SWEEP - Testing effect of density
    # ========================================================================
    {
        "nombre": "Base_N35_V25_D12",
        "num_cars": 35,
        "car_max_speed": 25.0,
        "car_acc_max": 2.5,
        "car_dec_max": 4.5,
    ...
    # Visual demo (watch the jam form!)
    {
        "nombre": "VISUAL_Demo_N40_V25_D15",
        "num_cars": 40,
        "car_max_speed": 25.0,
        "car_acc_max": 2.5,
        "car_dec_max": 4.5,
...
# ========================================================================
# 💤 COMMENTED OUT FOR FASTER TESTING - Uncomment to run full suite
# ========================================================================
"""
    # Original baseline scenarios (lower density, weaker jams)
    {
